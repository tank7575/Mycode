...
catcher = c.create_arc(catcher_start_x, catcher_start_y, \
                        catcher_start_x2, catcher_start_y2, start=200, extent=100, \
...
def lose_a_life():
    ...
    lives_remaining -= 1
    c.iteamconfigure(lives_text, text='Lives: '\
                    + str(lives_remaining))
...
def increase_score(points):
    ...
    c.iteamconfigure(score_text, text='Score: ' + str(score))
